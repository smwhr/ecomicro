...
$sql = "SELECT DISTINCTROW nompays,eco_pays.idpays,eco_pays.iduser,emaileco,devise,cptenat FROM eco_relation,eco_pays,eco_user WHERE (eco_user.iduser = '$idjoueur' AND ( eco_user.idpays = eco_relation.idpays1 OR eco_user.idpaysaccueil = eco_relation.idpays1 )  AND eco_pays.idpays = eco_relation.idpays2 AND eco_relation.vision = '0') ORDER BY nompays";
