...
$sql = "SELECT idpossession,eco_possession.idproduit,eco_possession.nomproduit,a.libelle as libellea,a.typeproduit,a.typeequi,eco_possession.image,nbunite,b.libelle as libelleb,datehachat FROM eco_possession,eco_typeproduit as a,eco_typeproduit as b WHERE b.typeproduit = eco_possession.idunite AND eco_possession.idpossesseur = '$citoyen' AND eco_possession.typeproduit = a.typeproduit";
