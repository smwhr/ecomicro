...
$sql = "SELECT DISTINCTROW eco_pays.idpays,nompays,nomentreprise,eco_entreprise.identreprise,typeentreprise,quantite,eco_typeproduit.libelle,eco_typeproduit.typeproduit,eco_typeproduit.typeequi ";
...
if ($num !=0)
{
        $tmp="var DET_STOC_NOMPAYS = new Array(";
        echo $tmp, $num,");";
        $tmp="var DET_STOC_IDPAYS = new Array(";
        echo $tmp, $num,");";
        $tmp="var DET_STOC_NOMENTREPRISE = new Array(";
        echo $tmp, $num,");";
        $tmp="var DET_STOC_IDENTREPRISE = new Array(";
        echo $tmp, $num,");";
...
{
        $tmp="var DET_STOC_NOMPAYS = new Array(0);";
        echo $tmp;
        $tmp="var DET_STOC_IDPAYS = new Array(0);";
        echo $tmp;
        $tmp="var DET_STOC_NOMENTREPRISE = new Array(0);";
        echo $tmp;
        $tmp="var DET_STOC_IDENTREPRISE = new Array(0);";
        echo $tmp;
