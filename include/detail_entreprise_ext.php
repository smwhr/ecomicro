...
$sql = "SELECT  DISTINCTROW eco_pays.idpays,nompays,identreprise,nomentreprise,eco_typeentreprise.typeentreprise,libelle,eco_entreprise.iduser,eco_user.nom,capacite ";
$sql .= "FROM eco_entreprise,eco_user, eco_pays,eco_typeentreprise,eco_relation ";
...
$sql .= "AND eco_entreprise.idpays = '$pays' ";

$sql .= "UNION SELECT  DISTINCTROW eco_pays.idpays,nompays,identreprise,nomentreprise,eco_typeentreprise.typeentreprise,libelle,'' as iduser,'' as nom,capacite ";
$sql .= "FROM eco_entreprise, eco_pays,eco_typeentreprise,eco_relation ";
...
$res = @mysqli_query($conn, $sql) or die("Probl�me dans la requ�te externe (DET_ENTRE_)");
	...
	while($produit = mysqli_fetch_array($res))
        {
              ...
              $res1 = @mysqli_query($conn, $sql1) or die("Probl�me dans la requ�te recher type �quivalent externe (DET_ENTRE_)");
