...
$sql = "SELECT DISTINCTROW 'E' as type, eco_possession.idpossession,eco_possession.etat,eco_pays.idpays,eco_pays.nompays,eco_possession.idpossesseur as idposs,eco_entreprise.nomentreprise as nom,idproduit,eco_typeproduit.typeproduit,eco_typeproduit.typeequi,nomproduit,image,description,nbunite,b.libelle as nomunite,b.typeproduit as idunite "; 
$sql .= "FROM eco_entreprise,eco_possession,eco_typeproduit as b,eco_pays,eco_typeproduit "; 
$sql .= "WHERE b.typeproduit = eco_possession.idunite AND eco_entreprise.identreprise = eco_possession.idpossesseur "; 
$sql .= "AND eco_entreprise.iduser > '0' AND (eco_possession.etat = '1' OR eco_possession.etat = '2')"; 
...
$sql .= "UNION SELECT DISTINCTROW 'C' as type, eco_possession.idpossession,eco_possession.etat,eco_pays.idpays,eco_pays.nompays,eco_possession.idpossesseur as idposs,eco_user.nom as nom,idproduit,eco_typeproduit.typeproduit,eco_typeproduit.typeequi,nomproduit,image,description,nbunite,b.libelle as nomunite,b.typeproduit as idunite "; 
$sql .= "FROM eco_user,eco_possession,eco_typeproduit as b,eco_pays,eco_typeproduit  "; 
