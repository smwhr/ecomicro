<html>
<head>
    <title>Données moyennes conseillées</title>
...
<table width='100%'>
  ...
  <br>
  <center>
  <b><FONT size=4>Données moyennes conseillées</FONT></b>
  </center>
...
&nbsp;&nbsp;- Invesissement dans l'économie citoyenne : 100 PP par mois en fonciton du nombre d'entreprise.
  <br>
&nbsp;&nbsp;- Salaire moyen mensuel : 800 P§
  <br>
&nbsp;&nbsp;- Impôts mensuels par entreprise : 1 000 à 1 500 P§
  <br>
&nbsp;&nbsp;- Masse monétaire : Nb de citoyens actifs * 100 000 P§
  <br>
&nbsp;&nbsp;- Taux de change : Aplication conseillée de la règle du K : 
  <br>
