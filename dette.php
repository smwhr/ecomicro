...
if (!$_SESSION['perso_iduser']){
    $verification ="formulaire.php?retour=dette.php";
...
<?php
  require("gestion/gest_dette.php");
?>

<script language="javascript" type="text/javascript" >
function majdette(i){
    var tmp = "";
    if (parseInt(document.getElementById('dette').value) <= 0){
        alert("Quel montant ?");
    }
    else{
        $('#page-loader').show();
        document.modifdette.action="gestion/modifdette.php";
        document.modifdette.submit();
    }
}
...
<body onload="infojoueur(); AfficheDette(); $('#page-loader').hide();" style="background-color:#E0E0E0;">

<script language="Javascript" type="text/javascript" src="gestion/gest_dette.js"></script>
                ...
                <tr>
                    <td valign=top>
                        ...
                        <div id="enteted" class="cadreClair"> 
                            <ul>
                                <li>Liste des dettes des entreprises.
    ...
    <tr>
        <td valign=top>
            <div class="cadrePrincipal">
                <div class="textGros"><CENTER><b>Dettes</b></CENTER></div>
                <div id="divLstDette">
                    <table border='0' width='100%' cellspacing="0">
                        <tr height='40'>
                            <td width='150'><CENTER><b>Pays</b></CENTER></td>
                            <td width='150'><b>&nbsp;Entreprise</b></td>
                            <td width='80'><CENTER><b>Dette</b></CENTER></td>
                            <td width='40'><CENTER><b>Dernière<br>maj</b></CENTER></td>
                        </tr>
                    </table>
                    <div id="dette" class="scroll-1"> </div>
                </div>
                <div id="divDette" style="display:none;"> </div>
            </div>
        </td>
