...
if (!$_SESSION['perso_iduser']){
    $verification ="formulaire.php?retour=bourse.php";
...
<html>
<head>
    <title>Gestion de la Bourse</title>
...
<?php
  require("gestion/gest_bourse.php");
?>
...
<body onload="infojoueur(); AfficheBourse(); $('#page-loader').hide();" style="background-color:#E0E0E0;">

<script language="Javascript" type="text/javascript" src="gestion/gest_bourse.js"></script>
                ...
                <tr>
                    <td valign=top>
                        ...
                        <div id="enteted" class="cadreClair"> 
                            <ul>
                                <li>Liste les cotations nationales.
                                <li>Les responsables ont la possibilité de les modifier.
                                <li>Si vous n'avez pas les droits, rien n'apparait.
                            </ul>
                        </div>
                    </td>
                </tr>
    ...
    <tr>
        <td valign=top>
            <div class="cadrePrincipal">
                <div class="textGros"><CENTER><b>Bourse</b></CENTER></div>
                <div id="divLstBourse">
                    <table border='0' width='100%' cellspacing="0">
                        <tr height='40'>
                            <td width='150'><CENTER><b>Pays</b></CENTER></td>
                            <td width='150'><b>&nbsp;Entreprise</b></td>
                            <td width='80'><CENTER><b>Cotation</b></CENTER></td>
                            <td width='80'><CENTER><b>Dernière<br>cotation</b></CENTER></td>
                            <td width='40'><CENTER><b>Dernière<br>maj</b></CENTER></td>
                        </tr>
                    </table>
                    <div id="bourse" class="scroll-1"> </div>
                </div>
                <div id="divBourse" style="display:none;"> </div>
            </div>
        </td>
