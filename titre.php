...
if (!$_SESSION['perso_iduser']){
    $verification ="formulaire.php?retour=titre.php";
...
<html>
<head>
    <title> Répartitions des titres</title>
...
<?php
  require("gestion/gest_titre.php");
?>
...
<script language="Javascript" type="text/javascript" src="gestion/gest_titre.js"></script>
                ...
                <tr>
                    <td valign=top>
                        ...
                        <div id="enteted" class="cadreClair"> 
                            <ul>
                                <li>Liste la r�partition des titres.
                            </ul>
                        </div>
                    </td>
                </tr>
    ...
    <tr>
        <td valign=top>
            <div class="cadrePrincipal">
                <div class="textGros"><CENTER><b>Répartitions des titres</b></CENTER></div>
                ...
                <div id="titre" class="scroll-1"> </div>
            </div>
        </td>
