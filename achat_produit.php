...
if (!$_SESSION['perso_iduser']){
    $verification ="formulaire.php?retour=achat_produit.php";
...
<?php
  require("gestion/gest_achat_produit.php");
?>

<script language="javascript" type="text/javascript" >
function valachat(i){
  var tmp = "";
  if (parseInt($('#nbprod').val()) <= 0){
     alert("Combien vous en voulez ??");
  }
  else{
      if (parseInt($("#rescalcul1").val()) > 0){
         Calcul();

         if ((parseInt($('#soldeA').val()) - parseInt($('#rescalcul1').val())) < 0){
            alert("Le solde ne le permet pas...");
         }
         else{
            $('#page-loader').show();
            document.achatstock.action="gestion/mes_achatproduit.php";
...
<body onload="infojoueur(); AfficheProduit(); $('#page-loader').hide();" style="background-color:#E0E0E0;">

<script language="Javascript" type="text/javascript" src="gestion/gest_achat_produit.js"></script>
                ...
                <tr>
                    <td valign=top>
                        ...
                        <div id="enteted" class="cadreClair textPetit"> 
                            <ul>
                                <li>Cet écran vous permet de proposer l'achat de produit.
    ...
    <tr>
        <td valign=top>
            <div class="cadrePrincipal">
                <div class="textGros"><CENTER><b>Achat de Produits</b></CENTER></div>
                <div id="divAchatProduit">
                    <table border='0' width='100%' cellspacing="0">
                        <tr height='40'>
                            <td width='100'><b>&nbsp;Pays</b></td>
                            <td width='130'><b>&nbsp;Entreprise</b></td>
                            <td width='150'><b>&nbsp;Produit</b></td>
                            <td width='200'><CENTER><b>Image</b></CENTER></td>
                            <td width='100'><CENTER><b>Valeur</b></CENTER></td>
                        </tr>
                    </table>
                    <div id="achatProduit" class="scroll-1"> </div>
                </div>
                <div id="divProduit" style="display:none;"> </div>
            </div>
        </td>
