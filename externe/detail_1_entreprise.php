...
<?php
  ...
  require("gest_detail_1_entreprise.php");
...
<script language="Javascript" type="text/javascript" src="gest_detail_1_entreprise.js"></script>
...
<ul>
    ...
    <li>Affiche le d�tail d'une entreprise.

    <li>Vous devez passez par EcoMicro si vous souhaitez plus d'information et pouvoir faire des actions (modifications, achats...).
    ...
    <li><a href="entreprise_detail.php?pays=1">Liste des entreprises</a>
