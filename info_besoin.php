...
$conn = @mysqli_connect($host,$user,$pass) or die("<br>0- Impossible de se connecter � la base de donn�es -- "); // Le @ ordonne a php de ne pas afficher de message d'erreur
  ...
  while($produit = mysqli_fetch_array($result))  {
    ...
    if ($entite == 'ETAT')    {
      ...
      while($prod1 = mysqli_fetch_array($res1))      {
		  ...
		  $html .= "<TR>";
		  $html .= "<TD>";
          $sql2 = "SELECT nompays FROM eco_pays ";
          $sql2 .= "WHERE idpays = '$idpays';";
          $res2 = @mysqli_query($conn, $sql2)or die("Erreur dans la requ�te de recherche de pays !!!");
		  $produit2 = mysqli_fetch_array($res2);
		  $html .= $produit2['nompays'];
		  $html .= "</TD>";
		  $html .= "<TD>";
          $sql2 = "SELECT nomentreprise FROM eco_entreprise ";
          $sql2 .= "WHERE identreprise = '$idprovince';";
          $res2 = @mysqli_query($conn, $sql2)or die("Erreur dans la requ�te de recherche de pays !!!");
		  $produit2 = mysqli_fetch_array($res2);
		  $html .= $produit2['nomentreprise'];
		  $html .= "</TD>";
		  $html .= "<TD>";
		  $html .= $type;
		  $html .= "</TD>";
		  $html .= "<TD>";
          $sql2 = "SELECT libelle FROM eco_typeproduit ";
          $sql2 .= "WHERE typeproduit = '$typeproduit';";
          $res2 = @mysqli_query($conn, $sql2)or die("Erreur dans la requ�te de recherche de pays !!!");
		  $produit2 = mysqli_fetch_array($res2);
		  $html .= $produit2['libelle'];
		  $html .= "</TD>";
		  $html .= "<TD>";
		  $html .= $besoin;
		  $html .= "</TD>";
