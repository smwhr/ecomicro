                ...
                <tr>
                    <td valign=top>
                        ...
                        <div id="enteted" class="cadreClair textPetit"> 
                            <ul>
                                <li>Cet écran vous permet de proposer l'achat de stock.
    ...
    <tr>
        <td valign=top>
            <div class="cadrePrincipal">
                <div class="textGros"><CENTER><b>Achat d'unités de Stock</b></CENTER></div>
                <div id="divAchatStock">
                    <table border='0' width='100%' cellspacing="0">
                        <tr height='40'>
                            <td width='250'><b>&nbsp;Pays</b></td>
                            <td width='250'><b>&nbsp;Entreprise - Province</b></td>
                            <td width='100' align=right><b>Quantité</b></td>
                        </tr>
                    </table>
