...
<?php
  require("gestion/gest_achat_pa.php");
?>
...
<body onload="infojoueur(); AffichePA(); $('#page-loader').hide();" style="background-color:#E0E0E0;">
    ...
    <tr>
        <td valign=top>
            <div class="cadrePrincipal">
                <div class="textGros"><CENTER><b>Petites annonces</b></CENTER></div>
                <div id="divAchatPA">
                    <table border='0' width='100%' cellspacing="0">
                        <tr height='40'>
                            <td width='100'><b>&nbsp;Pays</b></td>
                            <td width='130'><b>&nbsp;Propriétaire</b></td>
                            <td width='150'><b>&nbsp;Produit</b></td>
                            <td width='200'><CENTER><b>Image</b></CENTER></td>
                            <td width='100'><CENTER><b>Valeur</b></CENTER></td>
                        </tr>
                    </table>
                    <div id="achatPA" class="scroll-1"> </div>
                </div>
                <div id="divPA" style="display:none;"> </div>
            </div>
        </td>
